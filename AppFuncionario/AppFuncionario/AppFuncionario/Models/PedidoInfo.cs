...
namespace AppFuncionario
{
    public class PedidoInfo : INotifyPropertyChanged
    {
        ...
        private string _idClienteNotfs;
        public int idPedido 
        {
            get
            {
        ...
        public string idClienteNotfs
        {
            get
            {
                return _idClienteNotfs;
            }
            set
            {
                _idClienteNotfs = value;
                NotifyPropertyChanged("notificacoes mudadas?!");
            }
        }
        ...
        public PedidoInfo(Pedido p)
        {
            ...
            _idClienteNotfs = p.idCliente_notf;
        }

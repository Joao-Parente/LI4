            ...
            while (flag)
            {
                ...
                switch (input)
                {
                    ...
                    case 3: //Alterar Pedido
                        ...
                        if (res.Equals("S"))
                        {
                            Console.WriteLine("Indique os produtos que pretende adicionar (separados por um espa�o)");
                        ...
                        if (res.Equals("S"))
                        {
                            Console.WriteLine("Indique os produtos que pretende remover (separados por um espa�o)");
                            produtos = Console.ReadLine();
                    ...
                    case 12: //fazer reclamacao
                        ...
                        break;
                    case 13: //prods favoritos

                        Console.WriteLine("Insira o id do cliente");
                        string idClientePF = Console.ReadLine();

                        List<int> helloPF = ln.prodsFavoritos(idClientePF);
                        int aaaaaaa = 987;
